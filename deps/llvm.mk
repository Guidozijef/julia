...
LLVM_CMAKE += -DLLVM_BUILD_LLVM_DYLIB:BOOL=ON -DLLVM_LINK_LLVM_DYLIB:BOOL=ON -DLLVM_DYLIB_SYMBOL_VERSIONING:BOOL=ON
endif
...
$(eval $(call LLVM_PATCH,llvm-D30997-symbolver)) # Remove for 5.0
ifeq ($(BUILD_LLVM_CLANG),1)
