...
.. function:: Mmap.AnonymousMmap(name, readonly, create)
...
.. function:: mmap(io::Union(IOStream,AbstractString,Mmap.AnonymousMmap)[, type, dims, offset]; grow::Bool=true, shared::Bool=true)
              mmap(type, dims)
   ...
   If no ``type`` argument is specified, the default is ``UInt8``.
...
.. function:: mmap(io, BitArray, [dims, offset])
   ...
   **Example**:  ``B = mmap(s, BitArray, (25,30000))``
