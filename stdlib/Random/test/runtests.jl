...
using Random
using Random: dSFMT, Sampler, SamplerRangeFast, SamplerRangeInt, MT_CACHE_F, MT_CACHE_I
...
let mt = MersenneTwister(0)
    ...
    @test invoke(rand!, Tuple{MersenneTwister,AbstractArray{Float64},Random.SamplerTrivial{Random.CloseOpen_64}},
                 mt, AF64, Random.SamplerTrivial(Random.CloseOpen()))[end]  == 0.1142787906708973
end
